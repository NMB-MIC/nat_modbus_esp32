...
IPAddress local_IP(192, 168, 1, 202); // Static IP address192.168.100.164
IPAddress gateway(192, 168, 1, 1);    // Gateway IP address
IPAddress subnet(255, 255, 255, 0);     // subnet

char Machine_no[] = "GSSM02";
...
node.readHoldingRegisters(31, 1);   Serial.print("SHIELD1 USE COUNT : ");  Serial.println(node.getResponseBuffer(0));D14031= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(32, 1);   Serial.print("SHIELD2 USE COUNT : ");  Serial.println(node.getResponseBuffer(0));D14032= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(33, 1);   Serial.print("SNAP1 USE COUNT : ");  Serial.println(node.getResponseBuffer(0));D14033= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(34, 1);   Serial.print("SNAP2 USE COUNT : ");  Serial.println(node.getResponseBuffer(0));D14034= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(35, 1);   Serial.print("SHIELD1 LOSS : ");  Serial.println(node.getResponseBuffer(0));D14035= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(36, 1);   Serial.print("SHIELD2 LOSS : ");  Serial.println(node.getResponseBuffer(0));D14036= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(37, 1);   Serial.print("SNAP1 LOSS : ");  Serial.println(node.getResponseBuffer(0));D14037= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(38, 1);   Serial.print("SNAP2 LOSS : ");  Serial.println(node.getResponseBuffer(0));D14038= node.getResponseBuffer(0);  node.clearResponseBuffer();


  
digitalWrite(led_run, HIGH);  
  
D14001.toCharArray(i0,16);client.publish("GSSM02/D14001",i0);
D14002.toCharArray(i1,16);client.publish("GSSM02/D14002",i1);
D14003.toCharArray(i2,16);client.publish("GSSM02/D14003",i2);
D14004.toCharArray(i3,16);client.publish("GSSM02/D14004",i3);
D14005.toCharArray(i4,16);client.publish("GSSM02/D14005",i4);
D14006.toCharArray(i5,16);client.publish("GSSM02/D14006",i5);
D14007.toCharArray(i6,16);client.publish("GSSM02/D14007",i6);
D14008.toCharArray(i7,16);client.publish("GSSM02/D14008",i7);
D14009.toCharArray(i8,16);client.publish("GSSM02/D14009",i8);
D14010.toCharArray(i9,16);client.publish("GSSM02/D14010",i9);
D14011.toCharArray(i10,16);client.publish("GSSM02/D14011",i10);
D14012.toCharArray(i11,16);client.publish("GSSM02/D14012",i11);
D14013.toCharArray(i12,16);client.publish("GSSM02/D14013",i12);
D14014.toCharArray(i13,16);client.publish("GSSM02/D14014",i13);
D14015.toCharArray(i14,16);client.publish("GSSM02/D14015",i14);
D14016.toCharArray(i15,16);client.publish("GSSM02/D14016",i15);
D14017.toCharArray(i16,16);client.publish("GSSM02/D14017",i16);
D14018.toCharArray(i17,16);client.publish("GSSM02/D14018",i17);
D14019.toCharArray(i18,16);client.publish("GSSM02/D14019",i18);
D14020.toCharArray(i19,16);client.publish("GSSM02/D14020",i19);
D14021.toCharArray(i20,16);client.publish("GSSM02/D14021",i20);
D14022.toCharArray(i21,16);client.publish("GSSM02/D14022",i21);
D14023.toCharArray(i22,16);client.publish("GSSM02/D14023",i22);
D14024.toCharArray(i23,16);client.publish("GSSM02/D14024",i23);
D14025.toCharArray(i24,16);client.publish("GSSM02/D14025",i24);
D14026.toCharArray(i25,16);client.publish("GSSM02/D14026",i25);
D14027.toCharArray(i26,16);client.publish("GSSM02/D14027",i26);
D14028.toCharArray(i27,16);client.publish("GSSM02/D14028",i27);
D14029.toCharArray(i28,16);client.publish("GSSM02/D14029",i28);
D14030.toCharArray(i29,16);client.publish("GSSM02/D14030",i29);
D936.toCharArray(i30,16);client.publish("GSSM02/D936",i30);
D14031.toCharArray(i31,16);client.publish("GSSM02/D14031",i31);
D14032.toCharArray(i32,16);client.publish("GSSM02/D14032",i32);
D14033.toCharArray(i33,16);client.publish("GSSM02/D14033",i33);
D14034.toCharArray(i34,16);client.publish("GSSM02/D14034",i34);
D14035.toCharArray(i35,16);client.publish("GSSM02/D14035",i35);
D14036.toCharArray(i36,16);client.publish("GSSM02/D14036",i36);
D14037.toCharArray(i37,16);client.publish("GSSM02/D14037",i37);
D14038.toCharArray(i38,16);client.publish("GSSM02/D14038",i38);
rssi.toCharArray(i_rssi,16);client.publish("GSSM02/rssi",i_rssi);

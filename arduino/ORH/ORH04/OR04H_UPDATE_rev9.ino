...
IPAddress local_IP(192, 168, 4, 134); // ******Change ip *********
...
void loop() 
{
 ...
 node.readHoldingRegisters(30, 1); 
  ...
  d4040.toCharArray(i31, 16);client.publish("ORH04/D4040", i31);
  d4042.toCharArray(i32, 16);client.publish("ORH04/D4042", i32);

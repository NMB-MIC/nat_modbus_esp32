...
IPAddress local_IP(192, 168, 4, 133); // ******Change ip *********
...
void loop() 
{
 ...
 node.readHoldingRegisters(30, 1); 
  ...
  rssi.toCharArray(i_rssi, 16);client.publish("ORH03/rssi", i_rssi);
  zr2.toCharArray(i0, 16);client.publish("ORH03/ZR2", i0);
  zr6.toCharArray(i1, 16);client.publish("ORH03/ZR6", i1);
  zr532.toCharArray(i2, 16);client.publish("ORH03/ZR532", i2);
  zr552.toCharArray(i3, 16);client.publish("ORH03/ZR552", i3);
  zr572.toCharArray(i4, 16);client.publish("ORH03/ZR572", i4);
  zr632.toCharArray(i5, 16);client.publish("ORH03/ZR632", i5);
  zr652.toCharArray(i6, 16);client.publish("ORH03/ZR652", i6);
  zr672.toCharArray(i7, 16);client.publish("ORH03/ZR672", i7);
  zr732.toCharArray(i8, 16);client.publish("ORH03/ZR732", i8);
  zr752.toCharArray(i9, 16);client.publish("ORH03/ZR752", i9);
  zr772.toCharArray(i10, 16);client.publish("ORH03/ZR772", i10);
  d4000.toCharArray(i11, 16);client.publish("ORH03/D4000", i11);
  d4002.toCharArray(i12, 16);client.publish("ORH03/D4002", i12);
  d4004.toCharArray(i13, 16);client.publish("ORH03/D4004", i13);
  d4006.toCharArray(i14, 16);client.publish("ORH03/D4006", i14);
  d4008.toCharArray(i15, 16);client.publish("ORH03/D4008", i15);
  d4010.toCharArray(i16, 16);client.publish("ORH03/D4010", i16);
  d4012.toCharArray(i17, 16);client.publish("ORH03/D4012", i17);
  d4014.toCharArray(i18, 16);client.publish("ORH03/D4014", i18);
  d4016.toCharArray(i19, 16);client.publish("ORH03/D4016", i19);
  d4018.toCharArray(i20, 16);client.publish("ORH03/D4018", i20);
  d4020.toCharArray(i21, 16);client.publish("ORH03/D4020", i21);
  d4022.toCharArray(i22, 16);client.publish("ORH03/D4022", i22);
  d4024.toCharArray(i23, 16);client.publish("ORH03/D4024", i23);
  d4026.toCharArray(i24, 16);client.publish("ORH03/D4026", i24);
  d4028.toCharArray(i25, 16);client.publish("ORH03/D4028", i25);
  d4030.toCharArray(i26, 16);client.publish("ORH03/D4030", i26);
  d4032.toCharArray(i27, 16);client.publish("ORH03/D4032", i27);
  d4034.toCharArray(i28, 16);client.publish("ORH03/D4034", i28);
  d4036.toCharArray(i29, 16);client.publish("ORH03/D4036", i29);
  d4038.toCharArray(i30, 16);client.publish("ORH03/D4038", i30);
  d4040.toCharArray(i31, 16);client.publish("ORH03/D4040", i31);
  d4042.toCharArray(i32, 16);client.publish("ORH03/D4042", i32);

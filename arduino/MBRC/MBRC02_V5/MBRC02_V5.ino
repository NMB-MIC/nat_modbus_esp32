...
//////////////////////SETUP/////////////////////////
IPAddress local_IP(192, 168, 1, 14); // Static IP address192.168.100.164
IPAddress gateway(192, 168, 1, 1);    // Gateway IP address
IPAddress subnet(255, 255, 255, 0);     // subnet

char Machine_no[] = "MBRC02";
//////////////////////SETUP/////////////////////////
...
void loop() 
{
  ...
  delay(500);
  esp_task_wdt_reset();
  D6000.toCharArray(d1, 16);client.publish("MBRC02/D6000", d1);
  D6002.toCharArray(d2, 16);client.publish("MBRC02/D6002", d2);
  D6004.toCharArray(d3, 16);client.publish("MBRC02/D6004", d3);
  D6100.toCharArray(d4, 16);client.publish("MBRC02/D6100", d4);
  D6102.toCharArray(d5, 16);client.publish("MBRC02/D6102", d5);
  D6104.toCharArray(d6, 16);client.publish("MBRC02/D6104", d6);
  D6010.toCharArray(d7, 16);client.publish("MBRC02/D6010", d7);
  D6020.toCharArray(d8, 16);client.publish("MBRC02/D6020", d8);
  D6030.toCharArray(d9, 16);client.publish("MBRC02/D6030", d9);
  D6040.toCharArray(d10, 16);client.publish("MBRC02/D6040", d10);
  D6050.toCharArray(d11, 16);client.publish("MBRC02/D6050", d11);
  D6012.toCharArray(d12, 16);client.publish("MBRC02/D6012", d12);
  D6022.toCharArray(d13, 16);client.publish("MBRC02/D6022", d13);
  D6032.toCharArray(d14, 16);client.publish("MBRC02/D6032", d14);
  D6042.toCharArray(d15, 16);client.publish("MBRC02/D6042", d15);
  D6052.toCharArray(d16, 16);client.publish("MBRC02/D6052", d16);
  D6080.toCharArray(d17, 16);client.publish("MBRC02/D6080", d17);
  D6082.toCharArray(d18, 16);client.publish("MBRC02/D6082", d18);
  D6084.toCharArray(d19, 16);client.publish("MBRC02/D6084", d19);
  D6086.toCharArray(d20, 16);client.publish("MBRC02/D6086", d20);
  D6088.toCharArray(d21, 16);client.publish("MBRC02/D6088", d21);
  D6090.toCharArray(d22, 16);client.publish("MBRC02/D6090", d22);
  D6310.toCharArray(d23, 16);client.publish("MBRC02/D6310", d23);
  D6300.toCharArray(d24, 16);client.publish("MBRC02/D6300", d24);
  D6312.toCharArray(d25, 16);client.publish("MBRC02/D6312", d25);
  D6302.toCharArray(d26, 16);client.publish("MBRC02/D6302", d26);
  D32.toCharArray(d27, 16);client.publish("MBRC02/D32", d27);
  D6060.toCharArray(d28, 16);client.publish("MBRC02/D6060", d28);
  D6062.toCharArray(d29, 16);client.publish("MBRC02/D6062", d29);
  D6070.toCharArray(d30, 16);client.publish("MBRC02/D6070", d30);
  D6072.toCharArray(d31, 16);client.publish("MBRC02/D6072", d31);
  D616.toCharArray(d32, 16);client.publish("MBRC02/D616", d32);
  D936.toCharArray(d33, 16);client.publish("MBRC02/D936", d33);
  D12048.toCharArray(d48, 16);client.publish("MBRC02/D12048", d48);
  D12049.toCharArray(d49, 16);client.publish("MBRC02/D12049", d49);
  D12050.toCharArray(d50, 16);client.publish("MBRC02/D12050", d50);
  D12051.toCharArray(d51, 16);client.publish("MBRC02/D12051", d51);
  D12052.toCharArray(d52, 16);client.publish("MBRC02/D12052", d52);
  D12053.toCharArray(d53, 16);client.publish("MBRC02/D12053", d53);
  D12054.toCharArray(d54, 16);client.publish("MBRC02/D12054", d54);
  rssi.toCharArray(d_rssi, 16);client.publish("MBRC02/rssi", d_rssi);
  esp_task_wdt_reset();
  ...
  // ส่งข้อมูลผ่าน MQTT
  client.publish("MBRC02/json1", jsonStr.c_str());

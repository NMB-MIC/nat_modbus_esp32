...
IPAddress local_IP(192, 168, 4, 13); // Static IP address192.168.100.164
...
void loop() 
{
 ...
 node.readHoldingRegisters(13, 1); 
  ...
  zr1200.toCharArray(i0, 16);client.publish("IRR03/ZR1200", i0);
  zr1222.toCharArray(i1, 16);client.publish("IRR03/ZR1222", i1);
  d4000.toCharArray(i2, 16);client.publish("IRR03/D4000", i2);
  d4002.toCharArray(i3, 16);client.publish("IRR03/D4002", i3);
  d4004.toCharArray(i4, 16);client.publish("IRR03/D4004", i4);
  d4006.toCharArray(i5, 16);client.publish("IRR03/D4006", i5);
  d4008.toCharArray(i6, 16);client.publish("IRR03/D4008", i6);
  d4010.toCharArray(i7, 16);client.publish("IRR03/D4010", i7);
  d4012.toCharArray(i8, 16);client.publish("IRR03/D4012", i8);
  d4014.toCharArray(i9, 16);client.publish("IRR03/D4014", i9);
  d4016.toCharArray(i10, 16);client.publish("IRR03/D4016", i10);
  d4018.toCharArray(i11, 16);client.publish("IRR03/D4018", i11);
  d4020.toCharArray(i12, 16);client.publish("IRR03/D4020", i12);
  d4022.toCharArray(i13, 16);client.publish("IRR03/D4022", i13);
  rssi.toCharArray(i_rssi, 16);client.publish("IRR03/rssi", i_rssi);

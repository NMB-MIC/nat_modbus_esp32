...
IPAddress local_IP(192, 168, 4, 45); // Static IP address192.168.100.164
...
void loop() 
{
 ...
 node.readHoldingRegisters(37, 1); 
  ...
  rssi.toCharArray(i_rssi, 16);client.publish("IRB05/rssi", i_rssi);
  zr1410.toCharArray(i0, 16);client.publish("IRB05/ZR1410", i0);
  zr1414.toCharArray(i1, 16);client.publish("IRB05/ZR1414", i1);
  zr1416.toCharArray(i2, 16);client.publish("IRB05/ZR1416", i2);
  zr524.toCharArray(i3, 16);client.publish("IRB05/ZR524", i3);
  zr544.toCharArray(i4, 16);client.publish("IRB05/ZR544", i4);
  zr564.toCharArray(i5, 16);client.publish("IRB05/ZR564", i5);
  zr624.toCharArray(i6, 16);client.publish("IRB05/ZR624", i6);
  zr644.toCharArray(i7, 16);client.publish("IRB05/ZR644", i7);
  zr664.toCharArray(i8, 16);client.publish("IRB05/ZR664", i8);
  zr724.toCharArray(i9, 16);client.publish("IRB05/ZR724", i9);
  zr744.toCharArray(i10, 16);client.publish("IRB05/ZR744", i10);
  zr764.toCharArray(i11, 16);client.publish("IRB05/ZR764", i11);
  d5200.toCharArray(i12, 16);client.publish("IRB05/D5200", i12);
  d5220.toCharArray(i13, 16);client.publish("IRB05/D5220", i13);
  d5240.toCharArray(i14, 16);client.publish("IRB05/D5240", i14);
  d4000.toCharArray(i15, 16);client.publish("IRB05/D4000", i15);
  d4002.toCharArray(i16, 16);client.publish("IRB05/D4002", i16);
  d4004.toCharArray(i17, 16);client.publish("IRB05/D4004", i17);
  d4006.toCharArray(i18, 16);client.publish("IRB05/D4006", i18);
  d4008.toCharArray(i19, 16);client.publish("IRB05/D4008", i19);
  d4010.toCharArray(i20, 16);client.publish("IRB05/D4010", i20);
  d4012.toCharArray(i21, 16);client.publish("IRB05/D4012", i21);
  d4014.toCharArray(i22, 16);client.publish("IRB05/D4014", i22);
  d4016.toCharArray(i23, 16);client.publish("IRB05/D4016", i23);
  d4018.toCharArray(i24, 16);client.publish("IRB05/D4018", i24);
  d4020.toCharArray(i25, 16);client.publish("IRB05/D4020", i25);
  d4022.toCharArray(i26, 16);client.publish("IRB05/D4022", i26);
  d4024.toCharArray(i27, 16);client.publish("IRB05/D4024", i27);
  d4026.toCharArray(i28, 16);client.publish("IRB05/D4026", i28);
  d4028.toCharArray(i29, 16);client.publish("IRB05/D4028", i29);
  d4030.toCharArray(i30, 16);client.publish("IRB05/D4030", i30);
  d4032.toCharArray(i31, 16);client.publish("IRB05/D4032", i31);
  d4034.toCharArray(i32, 16);client.publish("IRB05/D4034", i32);
  d4036.toCharArray(i33, 16);client.publish("IRB05/D4036", i33);
  d4038.toCharArray(i34, 16);client.publish("IRB05/D4038", i34);
  d2754.toCharArray(i35, 16);client.publish("IRB05/D2754", i35);
  zr900.toCharArray(i36, 16);client.publish("IRB05/ZR900", i36);
  zr836.toCharArray(i37, 16);client.publish("IRB05/ZR836", i37);  

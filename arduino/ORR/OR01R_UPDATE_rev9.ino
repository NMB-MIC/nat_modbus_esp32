...
IPAddress local_IP(192, 168, 4, 101); // Static IP address192.168.100.164
...
void loop() 
{
 ...
 node.readHoldingRegisters(22, 1); 
  ...
  zr1200.toCharArray(i0, 16);client.publish("ORR01/ZR1200", i0);
  zr1232.toCharArray(i1, 16);client.publish("ORR01/ZR1232", i1);
  d4000.toCharArray(i2, 16);client.publish("ORR01/D4000", i2);
  d4002.toCharArray(i3, 16);client.publish("ORR01/D4002", i3);
  d4004.toCharArray(i4, 16);client.publish("ORR01/D4004", i4);
  d4006.toCharArray(i5, 16);client.publish("ORR01/D4006", i5);
  d4008.toCharArray(i6, 16);client.publish("ORR01/D4008", i6);
  d4010.toCharArray(i7, 16);client.publish("ORR01/D4010", i7);
  d4012.toCharArray(i8, 16);client.publish("ORR01/D4012", i8);
  d4014.toCharArray(i9, 16);client.publish("ORR01/D4014", i9);
  d4016.toCharArray(i10, 16);client.publish("ORR01/D4016", i10);
  d4018.toCharArray(i11, 16);client.publish("ORR01/D4018", i11);
  d4020.toCharArray(i12, 16);client.publish("ORR01/D4020", i12);
  d4022.toCharArray(i13, 16);client.publish("ORR01/D4022", i13);
  d4024.toCharArray(i14, 16);client.publish("ORR01/D4024", i14);
  d4026.toCharArray(i15, 16);client.publish("ORR01/D4026", i15);
  d4028.toCharArray(i16, 16);client.publish("ORR01/D4028", i16);
  d4030.toCharArray(i17, 16);client.publish("ORR01/D4030", i17);
  d4032.toCharArray(i18, 16);client.publish("ORR01/D4032", i18);
  d4034.toCharArray(i19, 16);client.publish("ORR01/D4034", i19);
  rssi.toCharArray(i_rssi, 16);client.publish("ORR01/rssi", i_rssi);
  d2754.toCharArray(i20, 16);client.publish("ORR01/D2754", i20);
  zr900.toCharArray(i21, 16);client.publish("ORR01/ZR900", i21);
  zr836.toCharArray(i22, 16);client.publish("ORR01/ZR836", i22); 

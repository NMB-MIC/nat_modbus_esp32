...
void loop() 
{
 ...
 node.readHoldingRegisters(35, 1); 
  ...
  d4040.toCharArray(i34, 16);client.publish("IRH01/D4040", i34);
  d4042.toCharArray(i35, 16);client.publish("IRH01/D4042", i35);
  zr0.toCharArray(i36, 16);client.publish("IRH01/ZR0", i36);
  zr30.toCharArray(i37, 16);client.publish("IRH01/ZR30", i37);
  zr32.toCharArray(i38, 16);client.publish("IRH01/ZR32", i38);
  d3000.toCharArray(i39, 16);client.publish("IRH01/D3000", i39);
  d3002.toCharArray(i40, 16);client.publish("IRH01/D3002", i40);
  d3004.toCharArray(i41, 16);client.publish("IRH01/D3004", i41);
  d3006.toCharArray(i42, 16);client.publish("IRH01/D3006", i42);
  d3008.toCharArray(i43, 16);client.publish("IRH01/D3008", i43);
  d3020.toCharArray(i44, 16);client.publish("IRH01/D3020", i44);
  d3022.toCharArray(i45, 16);client.publish("IRH01/D3022", i45);
  d3024.toCharArray(i46, 16);client.publish("IRH01/D3024", i46);
  d3026.toCharArray(i47, 16);client.publish("IRH01/D3026", i47);
  d3028.toCharArray(i48, 16);client.publish("IRH01/D3028", i48);
  d3012.toCharArray(i49, 16);client.publish("IRH01/D3012", i49);
  d3032.toCharArray(i50, 16);client.publish("IRH01/D3032", i50);

...
//////////////////////////////Barcode Scanner/////////////////////////////////////
  ...
  for(int i=0;i<num;i++)
  {
    ...
    x[i] = m[i].toInt();
    hexNum[i] = convertDecimalToHex(x[i]);
...
D11226.toCharArray(i225,16);client.publish("MBRR01/D11226",i225);
D11227.toCharArray(i226,16);client.publish("MBRR01/D11227",i226);
D11228.toCharArray(i227,16);client.publish("MBRR01/D11228",i227);
D11229.toCharArray(i228,16);client.publish("MBRR01/D11229",i228);
D11230.toCharArray(i229,16);client.publish("MBRR01/D11230",i229);
